...
@Route(path = MineRoutePath.LOAD_STATE_LAYOUT_ACTIVITY)
public class LoadStateLayoutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mine_activity_load_state_layout);

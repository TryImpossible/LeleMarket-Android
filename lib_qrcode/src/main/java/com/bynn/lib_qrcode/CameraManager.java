...
public final class CameraManager {
    ...
    public void openDriver(SurfaceHolder holder) throws IOException {
        if (camera == null) {
            ...
            camera.getParameters().setExposureCompensation(min);
            camera.setPreviewDisplay(holder);
            //int  a  = camera.getParameters().getExposureCompensation();
            //String white = camera.getParameters().getWhiteBalance();
            //List<String> list = camera.getParameters().getSupportedWhiteBalance();
            //int now = camera.getParameters().getExposureCompensation();
            //boolean lock = camera.getParameters().getAutoExposureLock();

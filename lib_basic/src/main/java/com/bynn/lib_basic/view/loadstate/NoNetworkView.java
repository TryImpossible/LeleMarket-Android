...
public class NoNetworkView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mContext = context;
        View view = LayoutInflater.from(mContext).inflate(R.layout.basic_no_network_view, this);
     ...
     * @param listener
     */
    private void setOnSettingClickListener(OnClickListener listener) {
    ...
    public static class Builder {
         ...
         * @param listener
         */
        private Builder setOnSettingClickListener(OnClickListener listener) {

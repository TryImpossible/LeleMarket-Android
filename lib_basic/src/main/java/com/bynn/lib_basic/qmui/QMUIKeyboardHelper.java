...
package com.bynn.lib_basic.qmui;
...
public class QMUIKeyboardHelper {
    ...
    public static ViewTreeObserver.OnGlobalLayoutListener setVisibilityEventListener(final Activity activity,
...
//
//                    @Override
//                    public void onActivityDestroyed(Activity destroyAct) {
//                        if (activity.getComponentName().equals(destroyAct.getComponentName())) {
//                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
//                                activityRoot.getViewTreeObserver()
...
//                });
    ...
    public static void removeVisibilityEventListener(final Activity activity,
                                                  final ViewTreeObserver.OnGlobalLayoutListener layoutListener) {
        if (activity == null) {
            return;
        }

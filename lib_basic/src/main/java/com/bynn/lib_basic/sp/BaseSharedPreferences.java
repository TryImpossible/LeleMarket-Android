...
public abstract class BaseSharedPreferences {
     ...
     * @param <T>
     */
    public <T> void removeObject(Context context, Class bean) {
     ...
     * @return
     */
    public <T> T getObject(Context context, Class<T> classOfT) {
        String key = classOfT.getClass().getSimpleName();
        Object object = get(context, key, "");
        return BaseApplication.getGson().fromJson((String) object, classOfT);
    }
